...
from src.SINMOD import SINMOD
from src.usr_func.vectorize import vectorize
from src.usr_func.normalize import normalize
from src.usr_func.calculate_analytical_ebv import calculate_analytical_ebv
...
class GRF:
    ...
    def __init__(self, filepath_prior: str = os.getcwd() + "/../sinmod/samples_2022.05.11.nc") -> None:
        ...
        # spatial correlation
        # self.__lateral_range = 200  # 680m in the experiment
        # self.__lateral_range = 700  # 680m in the experiment
        self.__lateral_range = .5  # .5m
        ...
        self.field = Field(neighbour_distance=.05)
